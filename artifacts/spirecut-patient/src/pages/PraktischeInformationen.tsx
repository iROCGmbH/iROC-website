...
export default function PraktischeInformationen() {
  ...
  const video1Title = sp.sp_video_praktisch_1_title?.trim()
    ? sp.sp_video_praktisch_1_title
    : t("praktisch.video1Title");
  const video2Title = sp.sp_video_praktisch_2_title?.trim()
    ? sp.sp_video_praktisch_2_title
    : t("praktisch.video2Title");
