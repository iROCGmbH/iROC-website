...
export function CountrySelect({ value, onChange, lang = 'de', placeholder, className }: CountrySelectProps) {
  ...
  return (
    <div ref={containerRef} className={`relative ${className ?? ''}`}>
      ...
      {open && filtered.length > 0 && (
        <div className="absolute z-50 w-full max-h-52 overflow-y-auto bg-background border rounded-md shadow-lg mt-1 text-sm">
