...
export default function SpirecutEN() {
  return (
      ...
      >
        ...
        <div className="relative w-full h-full p-[48px] flex flex-col z-20">
          ...
          <div className="text-center text-[19px] font-semibold text-[#002E56] mt-[12px] mb-[8px]">
            Dr. med. Maria Müller, residing in Munich
          </div>
          <div className="text-center text-[#333] text-[13px] leading-[1.9]">
            on 14 March 2026 successfully participated in the training:
          </div>

          {/* Course Title */}
          <div className="text-center text-[#002E56] text-[22px] font-semibold mt-4 mb-3">
            "Spirecut® Instruments and Technique for CTS and TF"
          </div>

          <div className="text-center text-[#555] text-[13px]">
            conducted by iROC GmbH in Aschheim.
          </div>
          ...
          <div className="mt-6 w-full">
            ...
            <div className="text-[#333] space-y-1 pl-[95px]" style={{ fontSize: 14, lineHeight: 1.75 }}>
              <div className="flex gap-2">
                ...
                <span>Application and handling of Spirecut® instruments</span>
              </div>
              <div className="flex gap-2">
                <span className="text-[#0070C0]">•</span>
                <span>Specifications for CTS and TF models</span>
              </div>
              <div className="flex gap-2">
                <span className="text-[#0070C0]">•</span>
                <span>Safety and optimal use</span>
              </div>
              <div className="flex gap-2">
                <span className="text-[#0070C0]">•</span>
                <span>Care and maintenance of instruments</span>
              </div>
            </div>
          </div>
